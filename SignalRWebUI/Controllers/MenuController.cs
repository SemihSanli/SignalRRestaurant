...
namespace SignalRWebUI.Controllers
{
    public class MenuController : Controller
    {
        ...
        public async Task<IActionResult> AddBasket(int id, int menuTableId)
        {
            ...
            CreateBasketDTOs createBasketDto = new CreateBasketDTOs
            {
                ProductID = id,
            ...
            var responseMessage = await client.PostAsync("https://localhost:7205/api/Basket", stringContent);

            var client2 = _httpClientFactory.CreateClient();
            //var jsonData2 = JsonConvert.SerializeObject(updateCategoryDto);
            //StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client2.GetAsync("https://localhost:7205/api/MenuTables/ChangeMenuTableStatusToTrue?id=" + menuTableId);
